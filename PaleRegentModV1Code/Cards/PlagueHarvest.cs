...
/// <summary>
/// 【疫收】技能牌（机制文档：瘟疫流，占位命名）。
/// 1 灵魂 技能：消耗手牌中所有【感染】，每张获得 2 点虚空并抽 1 张牌。
/// 升级后：每张获得 3 点虚空。
/// </summary>
public class PlagueHarvest() : PaleRegentModV1Card(1,
    ...
    TargetType.Self)
{
    private const int BaseVoidPerInfection = 2;

    /// <summary>升级后每张感染额外虚空。</summary>
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await CardPileCmd.Draw(choiceContext, infections.Count, cardPlay.Player);
    }
